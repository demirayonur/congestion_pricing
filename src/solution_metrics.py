...
def optimize_with_solution_metrics(instance, timeLimit=None, export_model=False, log_output=False, sensitivity=1e-6):
    ...
    if status == GRB.OPTIMAL:
        ...
        for a in arcs:
            ...
            mat_mul = sum([mu_[i].X * incidence_mat[i,a] for i in nodes])
    ...
    return obj_val, gap_val, sol_time, arc_utilization_rate, num_eq_constraints, num_ineq_constraints, num_binding_ineq_constraints
